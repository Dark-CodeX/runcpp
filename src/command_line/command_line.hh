...
namespace runcpp
{
    ...
    {
    public:
        static bool generate_config_helper();

        static bool run_command(const openutils::sstring &file_loc, const openutils::vector_t<openutils::sstring> &args, bool __print__);
